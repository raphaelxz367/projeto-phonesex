...
if mouse_check_button(mb_left) && atirou = 0 && balas>=1
{
atirou = 1	
balas -=1
 instance_create_layer(x,y,"Instances_1",obj_tiro)
}
}
if atirou = 1{
timer -=1
...
if obj_player.pose_gun = 1 && obj_player.metralhadora = 1 && equipada = 1
{
	if keyboard_check_pressed(ord("G"))	
		{
				jogar = 1
			     obj_player.metralhadora = 0
